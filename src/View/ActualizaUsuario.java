...
public class ActualizaUsuario extends javax.swing.JFrame {
    ...
    public ActualizaUsuario() {
     ...
     ResultSet rs;
        ...
        String query = "Select * from login order by usuario asc";
        try {
            ...
            Logger.getLogger(ActualizaUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Actualiza usuario");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int desicion,decision2;
         desicion=JOptionPane.showConfirmDialog(null,"Usuario: "+jTable1.getValueAt(seleccionar,0).toString()+
                                                "\nContraseña: "+jTable1.getValueAt(seleccionar,1).toString()+
                                                "\nJararquia: "+jTable1.getValueAt(seleccionar,2).toString()+
                                                 "\nCorreo electronico: "+jTable1.getValueAt(seleccionar,3).toString()+
                                                  "\nNombre Completo: "+jTable1.getValueAt(seleccionar,4).toString()+
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
     ...
     public void buscarUsuario(String nombre){
        ...
        String query = "Select * from login where usuario like '%"+nombre+"%' order by usuario asc";
